  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      if (data.user.role === "SUPER_ADMIN") {
        setError("Use o login SaaS para este usuario.");
        return;
      }
      setToken(data.token);
      setUser(data.user);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center app-shell px-6">
      <div className="card-glass rounded-3xl p-8 w-full max-w-md">
        <h1 className="font-display text-3xl text-white">Login do Clube</h1>
        <p className="text-slate-400 mt-2">Acesso para clubes assinantes.</p>
        <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              placeholder="financeiro@clube.com"
              value={email}
